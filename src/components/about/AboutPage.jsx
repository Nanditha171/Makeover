      ...
      <div className="container">
        ...
        <div className="grid-4" style={{ marginBottom: '3.5rem' }}>
          <div className="glass-card" style={{ padding: '1.5rem', textAlign: 'center' }}>
            <Briefcase size={28} style={{ color: 'var(--primary-rose-dark)', margin: '0 auto 0.5rem auto' }} />
            <div style={{ fontSize: '2.2rem', fontWeight: '800', color: 'var(--primary-rose-dark)' }}>{stats.yearsExperience}</div>
            <div style={{ fontSize: '0.85rem', color: 'var(--text-secondary)' }}>Years Professional Experience</div>
          </div>

          <div className="glass-card" style={{ padding: '1.5rem', textAlign: 'center' }}>
            <Users size={28} style={{ color: 'var(--primary-rose)', margin: '0 auto 0.5rem auto' }} />
            <div style={{ fontSize: '2.2rem', fontWeight: '800', color: 'var(--primary-rose)' }}>{stats.happyClients}</div>
            <div style={{ fontSize: '0.85rem', color: 'var(--text-secondary)' }}>Happy Brides & Clients</div>
          </div>

          <div className="glass-card" style={{ padding: '1.5rem', textAlign: 'center' }}>
            <Sparkles size={28} style={{ color: 'var(--primary-rose-dark)', margin: '0 auto 0.5rem auto' }} />
            <div style={{ fontSize: '2.2rem', fontWeight: '800', color: 'var(--primary-rose-dark)' }}>{stats.bridalMakeovers}</div>
            <div style={{ fontSize: '0.85rem', color: 'var(--text-secondary)' }}>Bridal Makeovers</div>
          </div>

          <div className="glass-card" style={{ padding: '1.5rem', textAlign: 'center' }}>
            <Star size={28} style={{ color: 'var(--primary-rose)', margin: '0 auto 0.5rem auto' }} />
            <div style={{ fontSize: '2.2rem', fontWeight: '800', color: 'var(--primary-rose)' }}>{stats.eventsCovered}</div>
            <div style={{ fontSize: '0.85rem', color: 'var(--text-secondary)' }}>Wedding & Event Projects</div>
          </div>
        </div>

        {/* Lead Artist Spotlight */}
        <div className="grid-2" style={{ alignItems: 'center', gap: '3rem', marginBottom: '4.5rem' }}>
          <div>
            <span className="badge badge-rose" style={{ marginBottom: '0.6rem' }}>Master Makeup Artist</span>
            <h3 style={{ fontSize: '2rem', marginBottom: '0.85rem' }}>Meet {salonInfo.artistName}</h3>
            <p style={{ color: 'var(--text-secondary)', marginBottom: '0.85rem', lineHeight: 1.6 }}>
            ...
            <div style={{ borderLeft: '3px solid var(--primary-rose)', paddingLeft: '1rem', marginBottom: '1.5rem', fontStyle: 'italic', color: 'var(--text-primary)', fontSize: '0.95rem' }}>
          ...
          <div>
            <img
              ...
              style={{ width: '100%', borderRadius: 'var(--radius-md)', border: '1px solid var(--border-rose)' }}
            />
          </div>
        </div>
        ...
        <div style={{ marginBottom: '4.5rem' }}>
          ...
          <div style={{ display: 'flex', flexWrap: 'wrap', gap: '0.75rem', justifyContent: 'center' }}>
            {brands.map((b, i) => (
              <div key={i} className="glass-card" style={{ padding: '0.75rem 1.5rem', fontWeight: '600', color: 'var(--primary-rose-dark)', fontSize: '0.95rem' }}>
                ✦ {b}
              </div>
            ))}
          </div>
        ...
        <div className="glass-card" style={{ padding: '2.5rem', background: 'var(--bg-secondary)', borderColor: 'var(--border-rose)' }}>
          ...
          <div className="grid-3">
            <div style={{ display: 'flex', gap: '0.75rem' }}>
              <CheckCircle2 size={20} style={{ color: 'var(--primary-rose-dark)', flexShrink: 0 }} />
              <div>
                <h4 style={{ fontSize: '1rem', color: 'var(--text-primary)', marginBottom: '0.3rem' }}>Single-Use Disposables</h4>
            ...
            <div style={{ display: 'flex', gap: '0.75rem' }}>
              <CheckCircle2 size={20} style={{ color: 'var(--primary-rose-dark)', flexShrink: 0 }} />
              <div>
                <h4 style={{ fontSize: '1rem', color: 'var(--text-primary)', marginBottom: '0.3rem' }}>UV Brush Sterilization</h4>
            ...
            <div style={{ display: 'flex', gap: '0.75rem' }}>
              <CheckCircle2 size={20} style={{ color: 'var(--primary-rose-dark)', flexShrink: 0 }} />
              <div>
                <h4 style={{ fontSize: '1rem', color: 'var(--text-primary)', marginBottom: '0.3rem' }}>Skin Prep & Patch Testing</h4>
